...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post by-lines.';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Editorial article \u2014 surfaced on the home Insights section and on /blog/[slug].';
  ...
  attributes: {
    ...
    heroAlt: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiCandidateCandidate extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'PII \u2014 never exposed on the public API. Read access restricted to inspire-admin role.';
  ...
  attributes: {
    ...
    assignedAgent: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    > &
      Schema.Attribute.Private;
    consentDataSharing: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    consentMarketing: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    consentTimestamp: Schema.Attribute.DateTime;
    ...
    languageProficiency: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Blocks & Schema.Attribute.Private;
    phone: Schema.Attribute.String & Schema.Attribute.Private;
    portfolio: Schema.Attribute.Media<'files' | 'images', true> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resume: Schema.Attribute.Media<'files'> & Schema.Attribute.Private;
    sectors: Schema.Attribute.JSON;
    skillTags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCommunitySignupCommunitySignup
  ...
  attributes: {
    ...
    registrantType: Schema.Attribute.Enumeration<
      ['jobseeker', 'employer', 'government', 'other']
    > &
      Schema.Attribute.Required &
...
export interface ApiCorridorCorridor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A destination corridor (UK, EU, USA, \u2026) shown in the home marquee.';
    displayName: 'Corridor';
    pluralName: 'corridors';
    singularName: 'corridor';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiDesignTokenDesignToken extends Struct.SingleTypeSchema {
  collectionName: 'design_tokens';
  info: {
    description: "CSS variable values that drive the entire site's brand surface.";
    displayName: 'Design Tokens';
    pluralName: 'design-tokens';
    singularName: 'design-token';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    accentDisplay: Schema.Attribute.Component<'tokens.color-pair', false>;
    accentInk: Schema.Attribute.Component<'tokens.color-pair', false>;
    background: Schema.Attribute.Component<'tokens.color-pair', false>;
    brandYellow: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'#F8BD26'>;
    breakpoints: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<{
        lg: 980;
        md: 880;
        sm: 640;
    ...
    fontBody: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Madimi One'>;
    fontDisplay: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Madimi One'>;
    line: Schema.Attribute.Component<'tokens.color-pair', false>;
    lineStrong: Schema.Attribute.Component<'tokens.color-pair', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    shadowCard: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'0 1px 2px rgba(10,10,10,0.04), 0 8px 24px rgba(10,10,10,0.06)'>;
    shadowHover: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'0 4px 8px rgba(10,10,10,0.06), 0 18px 40px rgba(10,10,10,0.1)'>;
    surface: Schema.Attribute.Component<'tokens.color-pair', false>;
    surfaceAlt: Schema.Attribute.Component<'tokens.color-pair', false>;
    text: Schema.Attribute.Component<'tokens.color-pair', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFormDefinitionFormDefinition
  ...
  info: {
    description: 'Editable form copy and field schema (replaces hard-coded labels in ContactForm.tsx etc.).';
  ...
  attributes: {
    ...
    >;
    notifyEmail: Schema.Attribute.Email & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFormSubmissionFormSubmission
  ...
  info: {
    description: 'PII from ContactForm / EmployersForm / GovernmentsForm. Public can POST; only admins can GET/PUT/DELETE.';
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Private;
    firstName: Schema.Attribute.String & Schema.Attribute.Private;
    formKey: Schema.Attribute.Enumeration<
      ['contact', 'employers', 'governments']
    > &
      Schema.Attribute.Required;
    ...
    payload: Schema.Attribute.JSON &
      ...
      Schema.Attribute.Private;
    phone: Schema.Attribute.String & Schema.Attribute.Private;
    processedAt: Schema.Attribute.DateTime & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recaptchaScore: Schema.Attribute.Decimal & Schema.Attribute.Private;
    status: Schema.Attribute.Enumeration<
      ['New', 'Acknowledged', 'InProgress', 'Closed', 'Spam']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'New'>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiJobPostingJobPosting extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Live international vacancies surfaced to workers and via the public API.';
  ...
  attributes: {
    ...
    destinationCity: Schema.Attribute.String;
    destinationCountry: Schema.Attribute.Enumeration<
      ['UK', 'EU', 'USA', 'Canada', 'Australia', 'Mauritius', 'Saudi Arabia']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiLegalDocumentLegalDocument
  ...
  info: {
    description: 'Privacy, Cookies, Terms, Modern Slavery \u2014 sticky-TOC long-form pages.';
  ...
  attributes: {
    ...
    controllerName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    eyebrow: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Legal'>;
    ...
    slug: Schema.Attribute.Enumeration<
      ['privacy', 'cookies', 'terms', 'modern-slavery']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
    ...
    tocAnchors: Schema.Attribute.Component<'blocks.toc-anchor', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Header, footer, and legal nav links.';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A marketing page built from a Dynamic Zone of sections.';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide brand, contact, and SEO defaults.';
  ...
  attributes: {
    ...
    communityBaseUrl: Schema.Attribute.String;
    companyAddress: Schema.Attribute.Component<'shared.postal-address', false>;
    companyNumber: Schema.Attribute.String;
    contactAfricaPhone: Schema.Attribute.String;
    contactEmail: Schema.Attribute.Email;
    contactLegalEmail: Schema.Attribute.Email;
    contactSpeakupEmail: Schema.Attribute.Email;
    contactUkPhone: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'INSPIRE AFRICA'>;
    publishedAt: Schema.Attribute.DateTime;
    socialLinks: Schema.Attribute.Component<'shared.social-link', true>;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Reusable labels for blog posts and job postings.';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
  ...
  attributes: {
    blog_posts: Schema.Attribute.Relation<
      ...
      'api::blog-post.blog-post'
    >;
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#F8BD26'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
